...
def load_model(
    ...
    model = FastLanguageModel.get_peft_model(
        ...
        use_gradient_checkpointing="unsloth",  # Add this for memory efficiency
        random_state=3407,  # Add random state for reproducibility
    )
...
def finetune(
    ...
    if finetuning_type == "sft":
        ...
        dataset2 = load_dataset("gahsilas/llmtwin-dpo", split="train[:10000]")
        ...
        trainer = SFTTrainer(
            ...
            max_seq_length=max_seq_length,
            dataset_num_proc=1,  # Reduced from 2 to avoid potential issues
            packing=True,
            args=TrainingArguments(
                ...
                report_to="comet_ml",
                seed=0,
                # Add these to handle potential memory/tensor issues
                dataloader_pin_memory=False,
                dataloader_num_workers=0,
                remove_unused_columns=False,  # Keep all columns to avoid mapping issues
            ),
        )
